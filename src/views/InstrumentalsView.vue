        ...
        <div class="wrapper">
          ...
          <div class="track-time">
            ...
            <div class="time">
              ...
              <div class="last-time">{{ currentSong.duration }}</div>
            </div>
          </div>
...
export default {
  ...
  mounted() {
    ...
    audioPlayer.addEventListener('timeupdate', (event) => {
      console.dir(event.target.currentTime);
      let currentMilliseconds = parseInt(event.target.currentTime);
      console.dir(currentMilliseconds);
      let minutes = Math.floor(currentMilliseconds / 360000);
  ...
  methods: {
    playPauseTrack(trackInfo) {
      ...
      if (fileURL === this.currentFileURL && this.trackPlaying) {
        ...
        this.currentSong.duration = audioPlayer.duration;
        audioPlayer.play();
        this.trackPlaying = true;
      }
