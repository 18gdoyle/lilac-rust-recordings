    ...
    <div id="pastProjectsPage" class="pageTopMargin">
        <div class="pastProjects">
            <PastProject
                ...
                :streamingServices="'https://linktr.ee/funkylamp'"
            ...
            ></PastProject>
            <PastProject
                :title="'Funky Lamp - Garden of Eden'"
                :date="'April 2022'"
            ...
            ></PastProject>
            <PastProject
                :title="'Lilac Rust - Waterview (Volume II)'"
                :date="'September 2021'"
            ...
            ></PastProject>
            <PastProject
                :title="'Lilac Rust - Popular Kids (Volume I)'"
                :date="'January 2021'"
            ...
            ></PastProject>
            <PastProject
                :title="'Lilac Rust - High Exposure (Volume I)'"
                :date="'September 2020'"
